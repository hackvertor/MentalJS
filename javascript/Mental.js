        ...
        function Mental() {
                ...
                function execute(code) {
                        ...
                        O: function(obj) {
                            ...
                            for(key in obj) {
                                ...
                                if(/^(?:toString|valueOf|constructor|hasOwnProperty)[$]$/.test(key)) {
                                    Object.defineProperty(obj,key.replace(new RegExp(replaceScoping.source+'$','i'),''), {configurable:true, enumerable: false, writable:true});
                                    Object.defineProperty(obj,key,{value:obj[key],enumerable: false, writable: true, configurable: true});
                                } else {
                                    if(key === 'length$') {
                                        Object.defineProperty(obj,key.replace(new RegExp(replaceScoping.source+'$','i'),''), {configurable:true, enumerable: true, writable:true});
                                        Object.defineProperty(obj,key,{
                                            set:function(len){ this.length=len; },get: function(){return this.length;},enumerable: false, configurable:true
                                        });
                                        continue;
                                    }
                                    Object.defineProperty(obj,key.replace(new RegExp(replaceScoping.source+'$','i'),''), {configurable:true, enumerable: true, writable:true});
                    ...
                    function createSandboxedNode(node) {
                        ...
                        Object.defineProperties(node, {
                            ...
                            'value$': {configurable:true, set:function(val){ this.value=val; }, get:function(){return this.value;}},
                            'ownerDocument$': {configurable:true, get:function(){return this.ownerDocument;}},
                    ...
                    function objWhitelist(obj, list, noprototype) {             
                        ...
                        for(var i=0;i<list.length;i++) {
                            ...
                            if(noprototype) {
                                ...
                                Object.defineProperty(obj.prototype,prop+scoping, {writable:false, configurable:true, enumerable:false, value:obj.prototype[prop]});
                            }
                        }
                        return obj;
                    }
        	...
        	function sandbox(code) {        			
    		    ...
    		    function unicodeEscape(first) {    		        
    		        pos++;
                    var chr1 = code.charCodeAt(pos), chr2 = code.charAt(pos+1), chr3 = code.charAt(pos+2), 
                        chr4 = code.charAt(pos+3), chr5 = code.charAt(pos+4), hex;                                                               
                    if(chr1 !== 0x75) {
